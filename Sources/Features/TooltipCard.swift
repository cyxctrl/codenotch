    ...
    var body: some View {
        stack
            ...
            .background {
                ...
                // the compat shim is what tells the compiler so on an old SDK.
                // Below that, `surfaceFill` has already painted the card opaque.
                if glassy {
                    Color.clear
                        .compatGlassEffect(surfaceStyle, in: TooltipSilhouette(direction: direction,
